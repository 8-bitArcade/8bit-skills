...
## Configuration
- **Vault location**: `C:\Users\123\Documents\AI_Vault\Admin` (Windows PC)
- **Remote host**: `100.110.93.103` (Windows PC, same as LM Studio)
- **Remote user**: `123`
...
2. Verified SSH connectivity: `ssh 123@100.110.93.103 "whoami"` → `gaming-ai-3090r\123`
3. Enabled `user_allow_other` in `/etc/fuse.conf` on VPS
4. Mounted vault: `sshfs 123@100.110.93.103:"C:/Users/123/Documents/AI_Vault/Admin" ~/.obsidian_vault -o allow_other,reconnect`
