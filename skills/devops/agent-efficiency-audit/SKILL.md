...
|---|---|
| Simple/status/formatting | nemotron-nano-4b |
...
- OpenRouter fallback jobs when LM Studio model is available (latency + cost)
...
- Cron job definitions are backed up (currently **NOT** in backup)
