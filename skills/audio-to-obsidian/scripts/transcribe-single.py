#!/usr/bin/env python3
"""Transcribe a single audio file - defaults to GPU (RTX 3090) for best quality, falls back to local CPU."""
...
def transcribe_on_gpu(audio_path):
    ...
    print(f"  ⚡ Transcribing on RTX 3090 (model: {GPU_MODEL})...")
...
def main():
    ...
    try:
        print(f"Attempting GPU transcription ({GPU_MODEL} on RTX 3090)...")
