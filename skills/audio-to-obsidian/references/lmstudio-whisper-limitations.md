...
## Security Note
User prefers {{AGENT_HOST}} transcription (data stays local) over SSH to {{DESKTOP_HOST}} with {{GPU_MODEL}}, even though GPU would be significantly faster. Privacy > speed.
